...
second_auth_channel = environ.get('SECOND_AUTH_CHANNEL', '-1001679066799')  # Add the second auth channel or Group (should private)
third_auth_channel = environ.get('THIRD_AUTH_CHANNEL', '-1002408192874')  # Add the third auth channel or Group (should private)
