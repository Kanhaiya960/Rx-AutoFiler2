...
second_auth_channel = environ.get('SECOND_AUTH_CHANNEL', '-1002332667665')  # Add the second auth channel or Group (should private)
third_auth_channel = environ.get('THIRD_AUTH_CHANNEL', '-1002461620614')  # Add the third auth channel or Group (should private)
