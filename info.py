...
second_auth_channel = environ.get('SECOND_AUTH_CHANNEL', '-1002446643155')  # Add the second auth channel or Group (should private)
third_auth_channel = environ.get('THIRD_AUTH_CHANNEL', '-1002327291915')  # Add the third auth channel or Group (should private)
