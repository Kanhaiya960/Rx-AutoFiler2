...
async def pm_text(bot, message):
    ...
    msgr = await message.reply_text(
        text=f"<b>ʜᴇʏ {user} 😍 ,\n\nɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ɢᴇᴛ ᴍᴏᴠɪᴇs ғʀᴏᴍ ᴛʜɪs ʙᴏᴛ ᴛʜᴇɴ ʏᴏᴜ ʜᴀᴠᴇ ᴛᴏ 𝗕𝗨𝗬 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 ғᴏʀ ᴛʜɪs ʙᴏᴛ.\n\nयदि आप इस बॉट से फिल्में प्राप्त करना चाहते हैं तो आपको इस बॉट के लिए प्रीमियम सदस्यता खरीदनी होगी।\n\n💵 sᴇᴇ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴs ➪ /plans 🎭\n💵 sᴇᴇ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴs ➪ /plans 🎭\n\nअन्यथा आप हमारे मुफ्त बॉट से फिल्में प्राप्त करें।\n𝗢𝘁𝗵𝗲𝗿𝘄𝗶𝘀𝗲 𝗬𝗼𝘂 𝗚𝗲𝘁 𝗠𝗼𝘃𝗶𝗲𝘀 𝗙𝗿𝗼𝗺 𝗢𝘂𝗿 𝗙𝗿𝗲𝗲 𝗕𝗼𝘁.</b>",
        disable_web_page_preview=True,
        reply_markup=InlineKeyboardMarkup([
              [InlineKeyboardButton("♂️ ᴡᴀᴛᴄʜ ғᴏʀ ғʀᴇᴇ ♂️", url="https://t.me/MovieSearchGroupHD")]
        ])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(6552970915))
        ],[
            InlineKeyboardButton("📲 ɪғ ᴜ ᴀʀᴇ ʟɪᴍɪᴛᴇᴅ sᴇɴᴅ ʜᴇᴀʀ", url=f"t.me/Kanus_Network_Bot")
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton("📲 ɪғ ᴜ ᴀʀᴇ ʟɪᴍɪᴛᴇᴅ sᴇɴᴅ ʜᴇᴀʀ", url=f"t.me/TonyStark_Botz")
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='purchase')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        btn = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(6552970915))
        ],[
            InlineKeyboardButton("📲 ɪғ ᴜ ᴀʀᴇ ʟɪᴍɪᴛᴇᴅ sᴇɴᴅ ʜᴇᴀʀ", url=f"t.me/TonyStark_Botz")
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('☎️ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', user_id=int(6552970915))
        ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/TonyStark_Botz")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
